...
public class AtlasParser : MonoBehaviour
{
    ...
    void ParseAtlasFile(string atlasText)
    {
        ...
        while ((line = reader.ReadLine()) != null)
        {
            ...
            Debug.Log($"Sprite: {spriteName}, X: {x}, Y: {y}, Width: {width}, Height: {height}");
        ...
        if (sprites.Count > 0)
        {
            ...
            Debug.Log("Background sprite assigned.");
        }
        else
        {
            Debug.LogError("No sprites were parsed from the atlas file.");
        }
    }
}
